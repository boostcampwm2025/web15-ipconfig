    ...
    <div className="flex flex-col rounded-2xl border border-slate-800 bg-slate-900/60 p-6 shadow-xl backdrop-blur transition-all hover:border-slate-700 hover:bg-slate-900">
      ...
      <div className="mt-auto flex flex-col gap-4">
        <Input
          ...
          {...register('code')}
          maxLength={32}
          className={`h-12 border border-[rgba(255,255,255,0.15)] text-center text-base transition-all duration-300 focus-visible:border-blue-500 focus-visible:ring-blue-500/50 ${errors.code ? 'border-red-500 focus-visible:border-red-500 focus-visible:ring-red-500/50' : ''}`}
        />
        {errors.code && (
